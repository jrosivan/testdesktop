...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  int screenIndex = ScreenSelected.orgaos.value;
  ...
  Widget createScreenFor(
    ...
    switch (screenSelected) {
      case ScreenSelected.orgaos:
        return const OrgaosScreen();
      case ScreenSelected.lancamentos:
        return const LancamentosScreen();
      case ScreenSelected.relatorios:
        return const RelatoriosScreen();
      case ScreenSelected.servicos:
      ...
      builder: (context, child) {
        return NavigationTransition(
          ...
          navigationRail: NavigationRail(
            extended: showLargeSizeLayout, //#fixa meu lateral com label, se TRUE!
...
class _NavigationTransitionState extends State<NavigationTransition> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(  // BODY - telas!!!!
      //backgroundColor: colorScheme.onSecondary, // Colors.blueGrey,
